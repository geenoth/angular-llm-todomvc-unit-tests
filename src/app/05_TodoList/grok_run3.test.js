...
describe('TodoListComponent', () => {
  ...
  it('should render todo items with correct title and completion status', () => {
    component.todos = [
      { id: '1', title: 'Test Todo 1', completed: false },
      { id: '2', title: 'Test Todo 2', completed: true }
    ];
  ...
  it('should log message when toggling todo', () => {
    const todo: Todo = { id: '1', title: 'Test Todo', completed: false };
    component.todos = [todo];
    fixture.detectChanges();
    ...
    const checkbox = fixture.nativeElement.querySelector('.toggle');
    checkbox.click();
    expect(console.log).toHaveBeenCalledWith('Toggled todo:', todo);
  });

  it('should log message when removing todo', () => {
    const todo: Todo = { id: '1', title: 'Test Todo', completed: false };
    component.todos = [todo];
    fixture.detectChanges();
    jest.spyOn(console, 'log');
    const destroyButton = fixture.nativeElement.querySelector('.destroy');
    destroyButton.click();
    expect(console.log).toHaveBeenCalledWith('Removing todo:', todo);
  });
});