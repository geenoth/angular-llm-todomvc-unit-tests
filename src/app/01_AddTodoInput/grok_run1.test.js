...
describe('AddTodoInputComponent', () => {
  ...
  it('should render the input field with correct placeholder', () => {
    const inputElement = fixture.nativeElement.querySelector('input[data-testid="add-todo-input"]');
    expect(inputElement).toBeTruthy();
    expect(inputElement.getAttribute('placeholder')).toBe('What needs to be done?');
  });

  it('should render the header with title "todos"', () => {
    const headerElement = fixture.nativeElement.querySelector('h1');
    expect(headerElement).toBeTruthy();
    expect(headerElement.textContent).toBe('todos');
  });
