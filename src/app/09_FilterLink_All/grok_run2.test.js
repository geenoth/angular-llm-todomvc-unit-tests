...
describe('FilterLinkAllComponent', () => {
  ...
  it('should have data-testid attribute for the link', () => {
    const linkElement = fixture.nativeElement.querySelector('[data-testid="filter-link-all"]');
  ...
  it('should call selectFilter method on link click', () => {
